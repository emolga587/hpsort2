  ...
  render() {
    return (
      <Grid container item xs={12} justify="center" style={{ textAlign: "center" }} spacing={1}>
        ...
        <Grid container item xs={12} justify="center" spacing={0}>
          <p>(updated)なハロプロソートです。<br />ソートアルゴリズムに<a href="https://en.wikipedia.org/wiki/Merge-insertion_sort">Ford-Johnson法</a>を採用しています。<br /><br />定期更新終了を宣言された本家様を勝手に引き継ぎ、新技術を反映しつつ鋭意改良中です。<br />(2021/3/27 各種情報の更新)</p>
        </Grid>
        ...
        <Grid container item xs={12} justify="center" spacing={0}>
          ...
          <p><a href="https://github.com/emolga587/hpsort2" target="_blank" rel="noreferrer">GitHub</a></p>
        </Grid>
      </Grid>
    );
  }
